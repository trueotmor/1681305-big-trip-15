...
import { TIME_FACTOR, MINUTES_PER_DAY, MINUTES_PER_HOUR } from '../const.js';
    ...
    options: {
      plugins: {
        datalabels: {
          ...
          anchor: 'end',
          align: 'start',
          formatter: (val) => `${dayjs.utc(val).format(getTripDurationFormat(val / TIME_FACTOR, MINUTES_PER_DAY, MINUTES_PER_HOUR))}`,
        },
      },
      title: {
        display: true,
